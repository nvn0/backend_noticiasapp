...
class ContentSafety(object):
    ...
    def make_decision(
        ...
        print("A: ", final_action.name)
        print(action_result)

        #return Decision(final_action, action_result)
        return final_action.name


def get_classification(conteudo):

    # Replace the placeholders with your own values
    endpoint = "https://azuresafety.cognitiveservices.azure.com/"
    subscription_key = "a51d9d8646e54d0f8962ef3857d41e8b"
    ...
    # Set the reject thresholds for each category (2/4/6)
    reject_thresholds = {
        Category.Hate: 2,
        Category.SelfHarm: 2,
        Category.Sexual: 2,
